...
class CourseSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        course_data = {
            ...
            'Prerequisites / Eligibility criteria': response.css('.eligible-right-top-list ul:nth-of-type(2) li::text').get(),
            'Content': response.css('.nav.nav-tabs.syl-ul li::text').getall(),
